  ...
  const I18N = {
    ...
    dictionaries: {
      ko: {
        ...
        sectionCrop: "잘라내기 (크롭/트리밍)",
        btnAutoTrim: "투명 여백 자동 자르기",
        btnAutoTrimTitle: "피사체 주변의 투명 여백을 자동으로 잘라냅니다",
        btnManualCrop: "영역 직접 선택하여 자르기",
        btnManualCropTitle: "캔버스에서 마우스로 자를 영역을 드래그하세요",
        btnApplyCrop: "자르기",
        btnCancelCrop: "취소",
        cropRatioFree: "자유",
        cropRatio1_1: "1:1",
        cropRatio4_3: "4:3",
        cropRatio16_9: "16:9",
        sectionResize: "이미지 리사이즈",
        currentResolution: "현재: $1 x $2 px",
        labelWidth: "너비 (W)",
        labelHeight: "높이 (H)",
        labelMaintainRatio: "가로세로 비율 유지",
        btnApplyResize: "크기 변경 적용",
        btnUndo: "되돌리기",
        btnRedo: "다시하기",
        btnUndoTitle: "실행 취소 (Ctrl+Z)",
        btnRedoTitle: "다시 실행 (Ctrl+Y)",
        btnDownloadPng: "이미지 다운로드",
        btnDownloadImage: "이미지 다운로드",
        labelSaveFormat: "저장 포맷",
        formatPngNotice: "PNG - 투명 지원",
        formatWebpNotice: "WEBP - 투명 지원 (고압축)",
        formatJpegNotice: "JPEG - 투명 미지원",
        formatGifNotice: "GIF - 투명 지원 (256색)",
        warnJpegNoTransparency: "JPEG는 투명 배경을 지원하지 않아 투명 영역이 흰색으로 저장됩니다.",
        warnGifQuality: "GIF는 256색 및 1비트 투명도를 사용하여 외곽선 경계에 계단 현상이 발생할 수 있습니다.",
        ...
        toastPngDownloaded: "이미지 다운로드가 완료되었습니다!",
        toastImageDownloaded: "이미지 다운로드가 완료되었습니다!",
        toastCopied: "투명 이미지가 클립보드에 복사되었습니다!",
        toastCopyFailed: "클립보드 복사 실패: $1",
        toastResizeSuccess: "이미지 크기가 $1 x $2 px로 조절되었습니다!",
        toastTrimSuccess: "투명 여백이 제거되었습니다! ($1 x $2 px)",
        toastNoTrimNeeded: "자르고 남은 투명 여백이 없습니다.",
        toastCropModeHint: "캔버스에서 자르고 싶은 영역을 마우스로 드래그하세요 (ESC: 취소)",
        toastCropSuccess: "선택 영역으로 잘라내었습니다! ($1 x $2 px)",
        alertTrimAllTransparent: "이미지에 피사체가 없거나 전체가 투명합니다.",
        alertInvalidDimensions: "너비와 높이는 1 이상의 유효한 숫자여야 합니다.",
      ...
      en: {
        ...
        sectionCrop: "Crop & Trim",
        btnAutoTrim: "Trim Transparent Margins",
        btnAutoTrimTitle: "Automatically crop transparent margins around subject",
        btnManualCrop: "Select Area to Crop",
        btnManualCropTitle: "Drag to select crop area on canvas",
        btnApplyCrop: "Crop",
        btnCancelCrop: "Cancel",
        cropRatioFree: "Free",
        cropRatio1_1: "1:1",
        cropRatio4_3: "4:3",
        cropRatio16_9: "16:9",
        sectionResize: "Image Resize",
        currentResolution: "Current: $1 x $2 px",
        labelWidth: "Width (W)",
        labelHeight: "Height (H)",
        labelMaintainRatio: "Keep aspect ratio",
        btnApplyResize: "Apply Resize",
        btnUndo: "Undo",
        btnRedo: "Redo",
        btnUndoTitle: "Undo (Ctrl+Z)",
        btnRedoTitle: "Redo (Ctrl+Y)",
        btnDownloadPng: "Download Image",
        btnDownloadImage: "Download Image",
        labelSaveFormat: "Save Format",
        formatPngNotice: "PNG - Supports Transparency",
        formatWebpNotice: "WEBP - Supports Transparency (High Compression)",
        formatJpegNotice: "JPEG - No Transparency",
        formatGifNotice: "GIF - Supports Transparency (256 Colors)",
        warnJpegNoTransparency: "JPEG does not support transparency. Transparent areas will be saved with a white background.",
        warnGifQuality: "GIF uses 256 colors and 1-bit transparency, which may cause jagged edges.",
        ...
        toastPngDownloaded: "Image download completed!",
        toastImageDownloaded: "Image download completed!",
        toastCopied: "Transparent image copied to clipboard!",
        toastCopyFailed: "Failed to copy to clipboard: $1",
        toastResizeSuccess: "Image resized to $1 x $2 px!",
        toastTrimSuccess: "Transparent margins trimmed! ($1 x $2 px)",
        toastNoTrimNeeded: "No transparent margins to trim.",
        toastCropModeHint: "Drag on canvas to select crop area (ESC to cancel)",
        toastCropSuccess: "Cropped to selected area! ($1 x $2 px)",
        alertTrimAllTransparent: "The image is empty or entirely transparent.",
        alertInvalidDimensions: "Width and height must be valid numbers greater than 0.",
