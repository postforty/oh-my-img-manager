...
- **수동 리터칭 브러시**: 지우개(Erase) 및 복원 펜(Restore)을 제공하여 덜 지워진 부분을 섬세하게 다듬고 실수한 영역을 완벽하게 되살릴 수 있습니다.
...
### 워크스페이스에서 대량 이미지 일괄 크롭하기
1. 확장 프로그램 팝업에서 **[대량 일괄 크롭 워크스페이스]**를 엽니다.
